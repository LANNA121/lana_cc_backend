...
public class ServiceResponseMessage implements Serializable {
    ...
    public static <T> ServiceResponseMessage createBySuccessCodeMessage(ResultCodeEnum resultCode, T data){
        ServiceResponseMessage serviceResponseMessage = new ServiceResponseMessage();
    ...
    public static ServiceResponseMessage createByFailCodeMessage(ResultCodeEnum resultCode, String msg){
        ServiceResponseMessage serviceResponseMessage = new ServiceResponseMessage();
    ...
    public static <T> ServiceResponseMessage createGeneralMessage(ResultCodeEnum resultCode, String msg, T data){
        ServiceResponseMessage serviceResponseMessage = new ServiceResponseMessage();
        serviceResponseMessage.meta = new Meta(resultCode.getCode(),msg);
        serviceResponseMessage.data = data;
        return serviceResponseMessage;
